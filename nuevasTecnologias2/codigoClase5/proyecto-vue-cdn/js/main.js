Vue.component('contador', {
    ...
    template: `
        <span>
            <button :class="['btn', getClassColor(),'btn-success','my-2','mr-2']" @click="contar()">Contar {{cont}}</button>
        </span>
    `
})
    ...
    computed: {
        calcularAlumnosCurso() {
            ...
            return {
                cantidad : cant,
                total : total, 
                ninguno: cant == 0,  // esto es booleano, es una condicion
                todos: cant == total,  // esto es booleano, es una condicion
                uno: cant == 1  // esto es booleano, es una condicion
            }
        }
    }
})